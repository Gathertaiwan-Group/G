...
const {
  upsertInfrastructure, updateTenantStatus, runTenantSql, hash,
  sendEmail, alertOps,
} = vi.hoisted(() => ({
  upsertInfrastructure: vi.fn(),
  updateTenantStatus: vi.fn(),
  runTenantSql: vi.fn(),
  hash: vi.fn().mockResolvedValue("bcrypthash"),
  sendEmail: vi.fn(),
  alertOps: vi.fn(),
}))
...
beforeEach(() => {
  vi.clearAllMocks()
  hash.mockResolvedValue("bcrypthash")
